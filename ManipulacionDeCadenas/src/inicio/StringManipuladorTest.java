...
public class StringManipuladorTest {
    public static void main(String[] arg) {
    	StringManipulador manipulator = new StringManipulador();
    	...
    	int d = manipulator.getIndexOrNull(word1, subString);
    	int e = manipulator.getIndexOrNull(word1, notSubString);
